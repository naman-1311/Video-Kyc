...
app = Flask(__name__)
app.config["IMAGE_UPLOADS"] = r"C:\Users\Naman\Pictures\Screenshots"
...
def formImg(fileName,dirname):
    ...
    for i in range(0, counter):
        ...
        imagePath = r"C:\\Users\\Bitcot\\Pictures\\Screenshots\\p" + \
            str(i)+".png"
        ...
        for (x, y, w, h) in faces:
            ...
            if(count==0):
                cv2.imwrite(f'C:\\Users\\Naman\\Pictures\\Screenshots\\face.jpg', roi_color)
                count=count+1
...
def camera():
    ...
    while( i < 200): 
        ...
        i=i+1
        if i==101:
            cv2.imwrite(f'C:\\Users\\Naman\\Pictures\\Screenshots{str(i)}.jpeg',frame)
...
def compare(dirname):
    ...
    target=f'C:\\Users\\Naman\\Pictures\\Screenshots\\dataset\\trial101.jpeg'
    directory=f'C:\\Users\\Naman\\Pictures\\Screenshots\\dataset\\face.jpg'
